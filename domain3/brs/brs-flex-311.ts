...
export const brsFlex311: BRSData = {
  ...
  postConditions: {
    accepted: [
      { id: "BRSFLEX311-2", description: "FIS har satt kvalificeringsstatus till 'Pending Test'." },
  ...
  process: [
    ...
    { id: "BRSFLEX311-12", description: "Flexibilitetsregistret bekräftar mottagandet av ansökan till SP." }
  ],
  exceptionFlow: [
