...
export const brsFlex813: BRSData = {
  ...
  diagramCode: `sequenceDiagram
    title BRS-FLEX-813: Notifiering om avstängning
    participant FIS as FIS
    participant SP as SP

    Note over FIS: Trigger: BRS-FLEX-810
    activate FIS
    FIS->>FIS: Sammanställ beslut och orsak
    FIS->>SP: NotifySuspension (Orsak, Startdatum)
    deactivate FIS`,
  preConditions: [
    { id: "BRSFLEX813-1", description: "En SP har stängts av administrativt (via BRS-FLEX-810)." }
  ],
  postConditions: {
    accepted: [
      { id: "BRSFLEX813-2", description: "SP har mottagit notifiering om avstängningen." }
    ],
    rejected: [
      { id: "BRSFLEX813-3", description: "Notifiering misslyckades." }
    ]
  },
  businessRules: [],
  process: [
    { id: "BRSFLEX813-4", description: "FIS skickar information om avstängningen till SP." },
    { id: "BRSFLEX813-5", description: "SP tar emot notifieringen." }
  ],
