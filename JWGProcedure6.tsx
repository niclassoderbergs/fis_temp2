...
const diagramCode = `sequenceDiagram
    title Procedure 6: Reactivation of a Controllable Unit
    participant RegP as Registration Responsible
    participant CUMA as CU Module Administrator

    RegP->>CUMA: 6.1 Request to reactivate CU (ID: A)
    activate CUMA
    CUMA->>CUMA: 6.2 Validate request
    
    alt Validation OK
        CUMA->>CUMA: Set status 'Active'
        CUMA-->>RegP: 6.3 Confirm reactivation (ID: B)
...
const steps = [
  { step: "6.1", action: "Request to reactivate CU", description: "The registration responsible requests to reactivate a suspended CU.", producer: "Registration responsible", receiver: "CU module administrator", infoId: "A" },
  { step: "6.2", action: "Validate request", description: "Validate that the reason for suspension is resolved.", producer: "CU module administrator", receiver: "Registration responsible", infoId: "B" },
  { step: "6.3", action: "Confirm reactivation", description: "Confirm execution to requester.", producer: "CU module administrator", receiver: "Registration responsible", infoId: "B" }
];
...
export const JWGProcedure6: React.FC<Props> = ({ onBack, onNavigateToBRS }) => {
  ...
  return (
    <div style={styles.container}>
      ...
      <h1 style={styles.header}>Procedure 6: Reactivation of a Controllable Unit</h1>
      ...
      <div style={styles.brsBox}>
        <div>
            ...
            <div style={{fontSize:'0.8rem', marginTop: '4px'}}>Hanteras som en uppdatering av status till 'Active'.</div>
        </div>
