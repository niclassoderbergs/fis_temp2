    ...
    <div style={styles.container}>
      <div style={styles.navHeader}>
        ...
        <div style={styles.navButtons}>
            <button style={styles.backButton} onClick={() => onNavigateToProcedure(23)}>← Föregående</button>
            <button style={styles.backButton} onClick={() => onNavigateToProcedure(25)}>Nästa →</button>
        </div>
      </div>
      ...
      <section>
        <h2 style={styles.sectionHeader}>Datainnehåll: Info BI (Request)</h2>
        <table style={styles.table}>
      ...
      <section>
        <h2 style={styles.sectionHeader}>Datainnehåll BRS (SPU - {brsFlex113.id})</h2>
        <p style={styles.paragraph}>Följande attribut ingår i specifikationen för {brsFlex113.id}.</p>
        <table style={styles.table}>
      ...
      <section>
        <h2 style={styles.sectionHeader}>Datainnehåll BRS (SPG - {brsFlex123.id})</h2>
        <p style={styles.paragraph}>Följande attribut ingår i specifikationen för {brsFlex123.id}.</p>
        <table style={styles.table}>
          <thead><tr><th style={styles.th}>Attribut</th><th style={styles.th}>Beskrivning</th><th style={{...styles.th, backgroundColor: '#e6effc', color: '#0052cc', borderBottom: '2px solid #b3d4ff'}}>JWG Referens</th></tr></thead>
          <tbody>
