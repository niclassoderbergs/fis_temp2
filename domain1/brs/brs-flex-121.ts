...
export const brsFlex121: BRSData = {
  ...
  diagramCode: `sequenceDiagram
    title BRS-FLEX-121: Notifiering om ny SPG (Admin)
    ...
    deactivate FIS`,
  preConditions: [
    { id: "BRSFLEX121-1", description: "En SPG har registrerats administrativt (via BRS-FLEX-1210)." }
  ],
  postConditions: {
    accepted: [
      { id: "BRSFLEX121-2", description: "SP har mottagit information om den nya SPG:n." }
    ],
    rejected: [
      { id: "BRSFLEX121-3", description: "Notifiering misslyckades." }
    ]
  },
  businessRules: [],
  process: [
    { id: "BRSFLEX121-4", description: "FIS skickar notifiering om den nya SPG:n." },
    { id: "BRSFLEX121-5", description: "SP tar emot informationen." }
  ],
