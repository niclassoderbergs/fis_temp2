...
export const brsFlex7121: BRSData = {
  ...
  diagramCode: `sequenceDiagram
    ...
    deactivate FIS`,
  preConditions: [
    { id: "BRSFLEX7121-1", description: "Verifiering av energibud är slutförd (via BRS-FLEX-7110)." }
  ],
  postConditions: {
    accepted: [
      { id: "BRSFLEX7121-2", description: "FIS har allokerat verifierad volym per Elleverantör." },
      { id: "BRSFLEX7121-3", description: "FIS har lagrat underlag för kompensation." }
    ],
    rejected: [
      { id: "BRSFLEX7121-4", description: "Allokering misslyckades." }
    ]
  },
  businessRules: [],
  process: [
    { id: "BRSFLEX7121-5", description: "FIS fördelar (allokerar) verifierad volym per Elleverantör (systemprocess)." },
    { id: "BRSFLEX7121-6", description: "FIS lagrar underlag för kompensation." }
  ],
