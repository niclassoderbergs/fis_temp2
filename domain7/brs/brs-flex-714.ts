...
export const brsFlex714: BRSData = {
  ...
  diagramCode: `sequenceDiagram
    title BRS-FLEX-714: SP notifieras om verifierat energibud
    ...
    deactivate FIS`,
  preConditions: [
    { id: "BRSFLEX714-1", description: "Systemet har verifierat ett aktiverat energibud (TSO/DSO) (via BRS-FLEX-7110)." },
    { id: "BRSFLEX714-5", description: "Systemet har verifierat DA/ID handel (via BRS-FLEX-7110)." }
  ],
  postConditions: {
    accepted: [
      { id: "BRSFLEX714-2", description: "Service Provider (SP) har mottagit verifieringsresultatet." }
    ],
    rejected: [
      { id: "BRSFLEX714-4", description: "Notifiering misslyckades." }
    ]
  },
  businessRules: [],
  process: [
    { id: "BRSFLEX714-6", description: "FIS skickar verifieringsresultatet till berörd SP." },
    { id: "BRSFLEX714-7", description: "SP tar emot informationen." }
  ],
