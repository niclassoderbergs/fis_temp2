...
export const mpsFlex400: MPSData = {
  ...
  scenarios: [
    ...
    DSO->>FIS: Begär resurslista för område (BRS-FLEX-401)
    FIS-->>DSO: Lista på mätpunkter returneras
    
    DSO->>FIS: Registrera tillfälligt effekttak (BRS-FLEX-402)
    activate FIS
    FIS->>FIS: Lagra begränsning
    FIS->>SP: Notifiera berörd SP om taket (BRS-FLEX-403)
    deactivate FIS`,
      steps: [
        { 
