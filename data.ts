...
import { brsFlex108 } from './domain1/brs/brs-flex-108'; // New
import { brsFlex105 } from './domain1/brs/brs-flex-105';
import { brsFlex106 } from './domain1/brs/brs-flex-106';
import { brsFlex107 } from './domain1/brs/brs-flex-107';
...
import { brsFlex1410 } from './domain1/brs/brs-flex-1410';
import { brsFlex1420 } from './domain1/brs/brs-flex-1420';
import { brsFlex144 } from './domain1/brs/brs-flex-144';

// MPS Domain 1
import { mpsFlex100, mpsFlex105, mpsFlex110, mpsFlex115, mpsFlex130, mpsFlex135, mpsFlex140 } from './domain1/mps/mps-domain-1';
...
import { mpsFlex205 } from './domain2/mps/mps-flex-205'; // New
...
import { mpsFlex305 } from './domain3/mps/mps-flex-305'; // New
import { mpsFlex310 } from './domain3/mps/mps-flex-310'; // New
...
import { mpsFlex505 } from './domain5/mps/mps-flex-505'; 
...
import { mpsFlex610 } from './domain6/mps/mps-flex-610'; // New
...
import { brsFlex717 } from './domain7/brs/brs-flex-717';
import { brsFlex716 } from './domain7/brs/brs-flex-716';
import { brsFlex718 } from './domain7/brs/brs-flex-718';
...
export const brsList: BRSData[] = [
  ...
  brsFlex101, brsFlex102, brsFlex103, brsFlex104, brsFlex1040, brsFlex108, brsFlex105, brsFlex106, brsFlex107,
  brsFlex110, brsFlex111, brsFlex112, brsFlex113, brsFlex114, brsFlex115, brsFlex116, brsFlex117, brsFlex118, brsFlex1110, 
  brsFlex120, brsFlex121, brsFlex122, brsFlex123, brsFlex124, brsFlex125, brsFlex126, brsFlex127, brsFlex128, brsFlex1210, 
  brsFlex130, brsFlex131, brsFlex1310, brsFlex1320, brsFlex134, brsFlex140, brsFlex141, brsFlex1410, brsFlex1420, brsFlex144,
  // Domän 2: Avtal & Marknad
  brsFlex201, brsFlex202, brsFlex203, brsFlex2040, brsFlex205, brsFlex206, brsFlex207, brsFlex208,
  // Domän 3: Produkt & Kvalificering
  brsFlex301, brsFlex302, brsFlex303, brsFlex305, brsFlex306, brsFlex311, brsFlex312, brsFlex313, brsFlex314, brsFlex315, brsFlex316, brsFlex317, brsFlex318, brsFlex321, brsFlex322, brsFlex323, brsFlex324, brsFlex325, brsFlex326, brsFlex330,
  // Domän 4: Nätbegränsningar
...
export const mpsList: MPSData[] = [
  mpsFlex100, mpsFlex105, mpsFlex110, mpsFlex115, mpsFlex130, mpsFlex135, mpsFlex140, 
  mpsFlex200, mpsFlex205, 
  mpsFlex300, mpsFlex305, mpsFlex310, 
  mpsFlex400, 
  mpsFlex500, mpsFlex505, 
  mpsFlex600, mpsFlex610, // Added 610
